# Script auto V8-Websocket
 Welcome MAT KILAU😊

 <h2 align="center">AutoScript VPN By auto <img src="https://img.shields.io/badge/Version-6.0-blue.svg"></h2>
...
## INSTALLATION SCRIPT
  ...
  ```html
  sysctl -w net.ipv6.conf.all.disable_ipv6=1 && sysctl -w net.ipv6.conf.default.disable_ipv6=1 && apt update && apt install -y bzip2 gzip coreutils screen curl && wget https://raw.githubusercontent.com/xe3r0/auto/main/setup.sh && chmod +x setup.sh && sed -i -e 's/\r$//' setup.sh && screen -S setup ./setup.sh
