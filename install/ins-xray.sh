...
wget -O certv2ray "https://raw.githubusercontent.com/${GitUser}/auto/main/cert.sh"
wget -O trojaan "https://raw.githubusercontent.com/${GitUser}/auto/main/menu/trojaan.sh"
wget -O xraay "https://raw.githubusercontent.com/${GitUser}/auto/main/menu/xraay.sh"
chmod +x port-xray
chmod +x certv2ray
chmod +x trojaan
chmod +x xraay
